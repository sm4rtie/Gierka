...
public class KrowaActivity extends AppCompatActivity implements View.OnClickListener{
    private Button gameBtn13;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_krowa_activity);

        gameBtn13 = (Button) findViewById(R.id.gameBtn13);
        ...
        gameImage = (ImageView) findViewById(R.id.gameImg13);
    ...
    public void setScreen(){
        ...
        Krowa krowa = new Krowa(this);
        answer = krowa.generateQuestion();
        int nr =  krowa.getResID();
