...
public class GamePicker {
    private static ArrayList<Class> activities = new ArrayList<Class>(Arrays.asList(MyszActivity.class, Game.class, KolkaActivity.class, MinkaActivity.class, AlfabetActivity.class));
