...
public class PandaActivity extends AppCompatActivity implements View.OnClickListener{
    private Button gameBtn12;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gameBtn12 = (Button) findViewById(R.id.gameBtn12);
        ...
        gameImage = (ImageView) findViewById(R.id.gameImg12);
    ...
    public void setScreen(){
        ...
        Panda panda = new Panda(this);
        answer = panda.generateQuestion();
        int nr =  panda.getResID();
