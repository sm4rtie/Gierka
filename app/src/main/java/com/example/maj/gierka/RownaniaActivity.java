...
public class RownaniaActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rownania_activity);

        gameBtn6 = (Button) findViewById(R.id.gameBtn6);
    ...
    public void setScreen(){
        ...
        Rownania rownania = new Rownania(this);
        answer = rownania.generateQuestion();
        int nr =  rownania.getResID();
