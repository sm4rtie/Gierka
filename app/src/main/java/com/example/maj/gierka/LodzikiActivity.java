...
public class LodzikiActivity extends AppCompatActivity implements View.OnClickListener{
    private Button gameBtn14;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lodziki_activity);

        gameBtn14 = (Button) findViewById(R.id.gameBtn14);
        ...
        gameImage = (ImageView) findViewById(R.id.gameImg14);
    ...
    public void setScreen(){
        ...
        Lodziki lodziki = new Lodziki(this);
        answer = lodziki.generateQuestion();
        int nr =  lodziki.getResID();
