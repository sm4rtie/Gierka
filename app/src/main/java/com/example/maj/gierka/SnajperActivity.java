...
public class SnajperActivity extends AppCompatActivity implements View.OnClickListener{
    private Button gameBtn15;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_snajper_activity);

        gameBtn15 = (Button) findViewById(R.id.gameBtn15);
        ...
        gameImage = (ImageView) findViewById(R.id.gameImg15);
        setScreen();
    }
    ...
    public void setScreen(){
        ...
        Snajper snajper = new Snajper(this);
        answer = snajper.generateQuestion();
        int nr =  snajper.getResID();
